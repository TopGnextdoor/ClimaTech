...
// Avoid syntax error on regex flags, use exact string replacement for the FontStyle block
...
// Standardizing fonts
content = content.replace(/Space Grotesk|DM Sans/g, (match) => match === 'Space Grotesk' ? 'Outfit' : 'Inter');
